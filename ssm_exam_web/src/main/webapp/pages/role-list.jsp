	...
	<div class="wrapper">
				...
				<div class="box box-primary">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/findByRid?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="/role/findAll?thispage=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
								</li>
								<li><a href="/role/findAll?thispage=${pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>

								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li <c:if test="${pageInfo.pageNum==pageNum}"> class="active" </c:if>><a href="/role/findAll?thispage=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>

								<li><a href="/role/findAll?thispage=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>

								<li>
									<a href="/role/findAll?thispage=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
		...
		<script>
			function changePageSize() {
				...
				//向服务器发送请求，改变没页显示条数
				location.href = "${pageContext.request.contextPath}/role/findAll?thispage=1&pageSize="
						+ pageSize;
			}
